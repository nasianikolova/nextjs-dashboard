...
import { updateInvoice } from '../../lib/actions'; // Direct relative import to actions file

export default function EditInvoiceForm({
  invoice,
  customers,
}) {
  // Bind the invoice.id to the update action so the server knows which entry to modify
